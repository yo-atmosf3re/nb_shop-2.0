...
import { SneakersBlockPropsType } from '../../../../@types/types'
   ...
   return (
      <div className="items__basket">
         ...
         <div className='basket__info'>
            <div onClick={onClickAddItem} className="basket__shoppingcart">
            ...
            <div className="basket__price">$ {divedesNumbers(price)}</div>
         </div>
      </div>
   )
})
